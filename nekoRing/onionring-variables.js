...
var sites = [
  // ['website.com','John Doe', 'This is John Doe's awesome website' ]
  [
  ...
  [
    ...
    "Seer",
    "Just a little corner of the web where an abnormal cornish rex cat shares his thoughts and talks about things he likes!!",
  ],*/
  [
...
// sites that are connected with webring members, and don't need to be their own individual sites.
var extras = [["https://tepiloxtl.nekoweb.org/", "https://tepiloxtl.net/"]];

var colors = ["blue", "cyan", "gray", "green", "pink", "purple", "yellow"];

//the name of the ring
var ringName = "nekowebring";

/* the unique ID of the widget. two things to note:
 1) make sure there are no spaces in it - use dashes or underscores if you must
 2) remember to change 'webringid' in the widget code you give out and all instances of '#webringid' in the css file to match this value!*/
var ringID = "nekowebring";

//should the widget include a link to an index page?
var useIndex = true;
//the full URL of the index page. if you're not using one, you don't have to specify anything here
var indexPage = "https://webring.nekoweb.org/members";
